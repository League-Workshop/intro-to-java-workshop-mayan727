...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String attack = JOptionPane.showInputDialog("Do you want to attack the dragon with yell or a kick?");

			// 9. If they typed in "yell":
			if (attack.equals("yells")) {
				dragondamage = new Random(1 - 10).nextInt(10);
			...
			if (attack.equals("kick")) {
				dragondamage = new Random(0 - 25).nextInt(25);
				dragonHealth = dragonHealth - dragondamage;
			...
			playersdamage = new Random(0 - 35).nextInt();
			playerHealth = playerHealth - playersdamage;
			...
			if (playerHealth <= 0) {
				...
				JOptionPane.showMessageDialog(null, "YAY THE DRAGON IS DEAD AND YOU TOOK A TON OF GOLD!");
			}

			JOptionPane.showMessageDialog(null,
					"your health is" + playerHealth + " the dragon health is" + dragonHealth);
